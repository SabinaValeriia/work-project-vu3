...
.container 
  form.card(action="", @submit.prevent="submit")
    ...
    .form-control(
      ...
      small(v-if="form.email.errors.required && form.email.touched") Please enter email
    .form-control(
      ...
      small(v-if="form.password.errors.required && form.password.touched") Please enter password
      small(
        v-else-if="form.password.touched && form.password.errors.minLength"
      ) 8 characters minimum
    button.btn.primary(type="submit", :disabled="!form.valid") Submit
</template>
